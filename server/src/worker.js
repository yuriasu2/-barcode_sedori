...
// 出品者ID単位のPro無料お試し期間のDO。出品者IDごとに1インスタンス。
export { SellerTrialDO } from './sellerTrialDurableObject.js';
...
export default {
  async fetch(request, env, ctx) {
    ...
    // 出品者ID単位のお試し期間のバインディング。sellerTrial.js側がglobalThis経由で参照する
    // (__quotaDO等と同じ簡易な受け渡し方式)。
    globalThis.__sellerTrialDO = env.SELLER_TRIAL || null;
