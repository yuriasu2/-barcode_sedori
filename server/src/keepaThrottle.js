...
// キューが撤去された現在、Proの優先度はこの適応ブレーキだけで表現する: Proは無料より
// 短い安全圏(=枯渇ギリギリまでブレーキが掛からない)にすることで、消費が枯渇へ向かう
// 局面ではまず無料側がブレーキで遅くなり、Proは残量がほぼ尽きるまで遅延なしで通る。
// §1の「Proを常に無料より優先する」という意図はこの形で一貫させる。
